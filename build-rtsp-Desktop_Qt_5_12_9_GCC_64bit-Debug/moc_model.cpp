...
void Model::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Model::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Model::frameReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Model::frameReady(const QImage & _t1)
{
